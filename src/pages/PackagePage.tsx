...
export function PackagePage() {
    ...
    const currentPackage = user?.Payment && user?.Payment[0]?.package.id;
    ...
    const onApprove = async (data: any) => {
        ...
        try {
            ...
            const user = await clientApi.get(`/company/me`, {
                headers: {
                    "x-auth-token": token,
                },
            });
                    ...
                    {packages?.map((pkg: Package) => (
                        ...
                        >
                            {currentPackage === pkg.id && (
                                <div className="absolute -top-4 bg-blue-400 text-white py-1 px-3 rounded-md">
